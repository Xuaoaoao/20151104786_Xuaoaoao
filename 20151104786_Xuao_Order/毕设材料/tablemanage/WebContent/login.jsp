...
<script src="images/verificationNumbers.js"></script>
<script src="images/Particleground.js"></script>
<script>
	$(document).ready(function() {
		createCode();
	});
	function hsgchecklogin() {
		if (document.f11.username.value == "" || document.f11.pwd.value == ""
	...
	<dl class="admin_login">
		<dt>
			<form name="f11" id="f11" method="post" action="hsgloginyanzheng.jsp">
				<strong><font color=white>台球俱乐部管理系统</font></strong> <em>TableManage
					System</em>
		</dt>
		<dd class="user_icon">
		...
		<dd class="val_icon">
			<div class="checkcode">
				<input type="text" placeholder="验证码" maxlength="4"
					class="login_txtbx" id="pagerandom" name="pagerandom">
			</div>
			&nbsp;
			<%
		...
		<dd>
			<input type="submit" value="立即登陆" class="submit_btn"
				onclick="return hsgchecklogin();" /> <input name="login"
				type="hidden" id="login" value="1">
		</dd>
		<dd></dd>
		</form>
	</dl>
